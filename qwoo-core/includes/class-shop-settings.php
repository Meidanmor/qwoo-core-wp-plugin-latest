...
class Shop_Settings_Builder {
    ...
    public function handle_github_push() {
        ...
        // 'pwa' pushes to public/config/pwa.json (name/description/theme_color/
        // background_color for the web app manifest).
        $allowed_pages = [ 'header', 'home', 'checkout', 'branding', 'pwa' ];
